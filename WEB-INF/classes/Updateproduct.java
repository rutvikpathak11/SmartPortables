...
public class Updateproduct extends HttpServlet {
  ...
  public void doGet(HttpServletRequest request,
	...
	out.println("<h1>Choose from below products to update details : </h1><br><br>");
		...
		out.println("<select name='updateproductnameparam' required>");
		...
		out.println("<input type='text' name='newprice' placeholder='Enter new price' required/></td>");
		out.println("</tr>");
		
		out.println("<tr>");
		out.println("<td>");
		out.println("New discount :");
		out.println("<input type='text' name='newdiscount' placeholder='Enter new price' required/></td>");
		out.println("</tr>");
		
		out.println("<tr>");
		out.println("<td>");
		out.println("New manufacturing rebate :");
		out.println("<input type='text' name='newrebate' placeholder='Enter new price' required/></td>");
		out.println("</tr>");
		
		out.println("<tr><td ><input type='submit' value='Update Product'></td></tr>");
		out.println("</table/>");
		out.println("</form>");
...
public void doPost(HttpServletRequest request,
	...
	String updateproductnameparam = request.getParameter("updateproductnameparam");
	String newprice = request.getParameter("newprice");
	String newdiscount = request.getParameter("newdiscount");
	String newrebate = request.getParameter("newrebate");	
	
	MySqlDataStoreUtilities obj1 = new MySqlDataStoreUtilities();
	obj1.updateproduct(updateproductnameparam,newprice,newdiscount,newrebate);

	out.println("<h1>Product has been updated successfully !!</h1>");
